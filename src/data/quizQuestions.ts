...
export const quizQuestions: QuizQuestion[] = [
  {
    ...
    type: "datetime",
    options: [
      { value: "rat", label: "Tý (23h-1h)", description: "23:00 - 01:00" },
      { value: "ox", label: "Sửu (1h-3h)", description: "01:00 - 03:00" },
      { value: "tiger", label: "Dần (3h-5h)", description: "03:00 - 05:00" },
      { value: "rabbit", label: "Mão (5h-7h)", description: "05:00 - 07:00" },
      { value: "dragon", label: "Thìn (7h-9h)", description: "07:00 - 09:00" },
      { value: "snake", label: "Tỵ (9h-11h)", description: "09:00 - 11:00" },
      { value: "horse", label: "Ngọ (11h-13h)", description: "11:00 - 13:00" },
      { value: "goat", label: "Mùi (13h-15h)", description: "13:00 - 15:00" },
      { value: "monkey", label: "Thân (15h-17h)", description: "15:00 - 17:00" },
      { value: "rooster", label: "Dậu (17h-19h)", description: "17:00 - 19:00" },
      { value: "dog", label: "Tuất (19h-21h)", description: "19:00 - 21:00" },
      { value: "pig", label: "Hợi (21h-23h)", description: "21:00 - 23:00" },
